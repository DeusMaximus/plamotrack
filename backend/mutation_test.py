...
"""Hand-rolled mutation testing for the #44 validation rules.
...
on `main` or comes out with the branch.
    ...
    uv run python mutation_test.py -k 4b     # cases whose label contains "4b"
...
CASES = [
    ...
    (
        "3a. clearing allowed, arrival still refused",
        INV,
    ...
    (
        "3b. only the stored lines count",
        INV,
    ...
    (
        "3c. any received_at change refused, not just a transition",
        INV,
        "        if not (arriving or clearing):\n            continue",
        "        pass",
    ...
    (
        "3d. refused regardless of catalog lines",
        INV,
        "        if not types:\n",
        "        if False:\n",
    ...
    (
        "3e. the value compared instead of the change",
        INV,
    ...
    (
        "4a. a quantity the sheet never states still reconciles",
        IMP,
    ...
    (
        "4b. progressed kits are removable",
        IMP,
    ...
    (
        "4c. kits the upload describes are removable",
        IMP,
        "        candidates = [\n            kit for kit in attached if kit.id not in described and kit.id not in protected\n        ]",
    ...
    (
        "4d. removals stay out of the fingerprint",
        IMP,
    ...
    (
        "5a. the clock is read at plan time instead of apply time",
        IMP,
    ...
    (
        "5b. a stated timestamp no longer wins",
        IMP,
    ...
    (
        "6. attached-after ignores reparenting entirely",
        IMP,
    ...
    (
        "6a. kits moved onto the line are not counted",
        IMP,
    ...
    (
        "6b. kits moved off the line are still counted",
        IMP,
    ...
    (
        "6c. a row that never mentions order_item_id moves the kit anyway",
        IMP,
    ...
    (
        "7. the clearing refusal offers only the catalog file",
        INV,
    ...
    (
        "8. the fan-out classifies from values alone",
        IMP,
    ...
    (
        "8a. a created line counts nothing as attached",
        IMP,
        "            attached = self._attached_after(line_id, stored, kit_rows)",
    ...
    (
        "9. kit-side lines are not checked at all",
        IMP,
    ...
    (
        "9a. only the line a kit moves TO is considered",
        IMP,
    ...
    (
        "9b. a reconciled line is checked for a count anyway",
        IMP,
    ...
    (
        "9c. kit creates are left out of the post-write count",
        IMP,
    ...
    (
        "12. a line naming no quantity still authorises reconciliation",
        IMP,
    ...
    (
        "11. replace_all consults the stored order-item row",
        IMP,
    ...
    (
        "13. a kit may name a catalog order line as provenance",
        IMP,
    ...
    (
        "14. the fan-out runs before the refusals again",
        IMP,
    ...
    (
        "15. an unstated quantity does not fall back to the stored row",
        IMP,
    ...
    (
        "16. add_only trusts the skipped upload row instead of stored state",
        IMP,
    ...
    (
        "17. refusal writes a message but does not error the row before fan-out",
        IMP,
        "    @staticmethod\n"
    ...
    (
        "16. a protected kit's provenance can be stripped",
        IMP,
    ...
    (
        "16a. only a cleared link counts, not a moved one",
        IMP,
    ...
    (
        "17. protection ignores a status this upload writes",
        IMP,
    ...
    (
        "17a. protection ignores a child this upload creates",
        IMP,
    ...
    (
        "17b. protection ignores a rating this upload writes",
        IMP,
    ...
    (
        "17c. protection ignores stored evidence",
        IMP,
    ...
    (
        "18. only child CREATEs count as protection",
        IMP,
    ...
    (
        "19. a created line is exempt from over-supply",
        IMP,
    ...
    (
        "19a. over-supply by the upload borrows the stored-kit message",
        IMP,
        "            if not attached:",
        "            if False:",
        "creates_cannot_be_over_supplied_either",

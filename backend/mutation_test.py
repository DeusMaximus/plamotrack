...
CASES = [
    ...
    (
        "moa-37. the code exchange not serialized per code (two redemptions mint)",
        MCP_OAUTH,
    ...
    (
        "moa-38. the refresh exchange not serialized per refresh token",
        MCP_OAUTH,
    ...
    (
        ...
        "            and True",
        "new_id_token_on_refresh_is_verified_and_must_name_the_owner",
    ),
    (

...
async def search_catalog(
    ...
    """Typeahead across every catalog table — the select-or-create flow's
...
async def adjust_stock(catalog_id: uuid.UUID, data: StockAdjustmentRequest, session: SessionDep):
    """Adjust stock by a signed delta, resolving the id across the catalog
    ...
    409 if the result would be negative; 404 if no catalog item carries that id."""
